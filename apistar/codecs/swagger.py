...
SWAGGER = validators.Object(
    ...
    properties=[
        ...
        (
            "parameters",
            validators.Object(additional_properties=validators.Ref("Parameters")),
        ),
        (
            "responses",
        ...
        (
            "securityDefinitions",
            validators.Object(additional_properties=validators.Ref("SecurityScheme")),
        ),
...
class SwaggerCodec(BaseCodec):
    ...
    def get_operation(self, link, operation_id, tag=None, schema_defs=None):
        ...
        if link.get_body_field():
            ...
            operation["requestBody"] = {"content": {link.encoding: content_info}}
